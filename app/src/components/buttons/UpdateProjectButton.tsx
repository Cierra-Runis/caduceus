          ...
          onValid={(data) =>
            trigger(data, {
              ...
              onSuccess: () => {
                ...
                // Team lists are matched by key prefix so this works with the
                // constant 'team/projects' key as well as per-team-id keys
                // ('team/projects?id=...').
                mutate('user/projects');
                mutate(
                  (key) =>
                    typeof key === 'string' && key.startsWith('team/projects'),
                );
              },
            })
          }
